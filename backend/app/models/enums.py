...
class EventType(str, Enum):
    ...
    EVIDENCE_AGGREGATION_STARTED = "evidence_aggregation_started"
    RESOLUTION_ROUND_STARTED = "resolution_round_started"
    ...
    HUMAN_QUESTION_GENERATED = "human_question_generated"
    TTS_STARTED = "tts_started"
    TTS_COMPLETED = "tts_completed"
    AUDIO_UPLOADED = "audio_uploaded"
    ESCALATION_COMPLETED = "escalation_completed"
    GEMMA_STARTED = "gemma_started"
    GEMMA_SUMMARY_GENERATED = "gemma_summary_generated"
    GEMMA_REVIEW_COMPLETED = "gemma_review_completed"
    GEMMA_COMPLETED = "gemma_completed"
